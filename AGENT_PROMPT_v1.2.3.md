...
### Die 7 wichtigsten Regeln die du beachten musst

#### 0. Git Branch Workflow (NEU!)

**Regel:** Arbeite NICHT mehr direkt auf `main`!
1.  **Feature Branches:** Nutze `develop` oder `feature/xyz` für Änderungen.
2.  **Pull Requests:** Code wird erst nach Prüfung gemerged.
3.  **Frontend Refactoring:** Beachte den Plan in `HANDOVER_v1.2.3.md` (Ziel: TypeScript/Lit/Vite für v1.3.0).

#### 1. Versions-Konsistenz & Documentation (NEU & KRITISCH!)
