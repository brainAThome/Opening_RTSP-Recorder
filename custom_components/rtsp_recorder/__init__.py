...
Modularized components are imported from:
- const.py: Constants and configuration defaults
- helpers.py: Utility functions and InferenceStatsTracker
- face_matching.py: Face embedding matching algorithms
- people_db.py: People database CRUD operations
- analysis_helpers.py: Analysis result processing
"""
import logging
import os
import re
...
# Get the global inference stats tracker from helpers module
