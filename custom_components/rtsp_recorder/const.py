...
DEFAULT_FACE_MULTISCALE = True  # v1.2.3: Multi-scale face detection (better accuracy, more CPU)
DEFAULT_OVERLAY_SMOOTHING = False
DEFAULT_OVERLAY_SMOOTHING_ALPHA = 0.35
DEFAULT_FACE_ONLY_IF_PERSON = False
DEFAULT_MOVENET_ONLY_IF_PERSON = False
