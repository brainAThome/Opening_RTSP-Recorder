    ...
    async def async_step_analysis(self, user_input: Optional[Dict[str, Any]] = None) -> config_entries.FlowResult:
        ...
        if user_input is not None:
            ...
            if not errors:
                ...
                self.config_cache["analysis_face_multiscale"] = bool(user_input.get("analysis_face_multiscale", True))
        ...
        cur_face_multiscale = bool(self.config_cache.get("analysis_face_multiscale", True))
        ...
        schema = vol.Schema({
            ...
            vol.Required("analysis_face_confidence", default=cur_face_confidence): selector.NumberSelector(
                selector.NumberSelectorConfig(min=0.1, max=0.8, step=0.05, mode=selector.NumberSelectorMode.SLIDER)
            ),
            ...
            vol.Required("analysis_face_multiscale", default=cur_face_multiscale): selector.BooleanSelector(),
